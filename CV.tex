...
\rhead{}
\lfoot{
\cfoot{\scriptsize  Andrew Koech - CV }}
...
\hypersetup{unicode=true,
            pdftitle={Andrew Koech:  CV (Curriculum Vitae)},
            pdfauthor={Andrew Koech},
...
\centerline{\huge \bf Andrew Koech}
...
\moveleft.5\hoffset\centerline{Masters Candidate, University of Bremen}
\moveleft.5\hoffset\centerline{Forststrasse 48 · 14471 · Potsdam,
Germany}
\moveleft.5\hoffset\centerline{ \faEnvelopeO \hspace{1 mm} \href{mailto:}{\tt \href{mailto:akoech@gmx.com}{\nolinkurl{akoech@gmx.com}}} \hspace{1 mm}  \faPhone \hspace{1 mm}  +49
1 777 892
226  \hspace{1 mm}  \faGithub \hspace{1 mm} \href{http://github.com/koechandy}{\tt koechandy} \hspace{1 mm}       | \emph{Updated:} \apstylekinda\today} 
...
\tightlist
\item
  \emph{Survival Analysis, Statistical Genomics, Machine Learning
  Modelling}
\end{itemize}
...
\tightlist
\item
  \textbf{M.Sc} in Medical Biometry/Biostatistics \hfill Sept.~2022 -
  Ongoing
\end{itemize}
...
\textbf{Data Officer} \hfill Aug.~2019 - Apr.~2021
...
\item
  Prepare articles for publication and presentation at professional
...
\item
  Work with investigators to formalize analysis plans and reporting
  specifications.
\item
  Develop statistical analysis plans and write program code to analyze
  data using SAS/R or Stata.
\item
  Preparation of clinical trial documents, and responses to requests
  from the local Institutional Review Board, and other health
  authorities.
\end{itemize}

\emph{AMPATH Oncology Institute} \hfill \emph{Eldoret, Kenya}

\textbf{Data Assistant} \hfill Sept.~2018 - Jul.~2019
...
\item
  Compile reports, charts and graphs that describe and interpret
...
\tightlist
\item
  Data prepreparation (cleaning and wrangling) and statistical
  analysis/exploratory visualization with R Markdown (advanced dplyr and
  ggplot2 package applications)
\item
